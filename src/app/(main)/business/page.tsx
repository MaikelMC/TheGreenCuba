...
function DashboardView() {
  return (
    <>
      <div className="view-header flex items-center justify-between gap-gap-sm mb-gap-lg">
        <div>
...
function EditorView() {
  ...
  const [description, setDescription] = useState(
    "Restaurante de cocina cubana contemporánea en el corazón de Vedado. Especializado en ropa vieja, lechón asado y cócteles tropicales. Ambiente elegante con música en vivo los fines de semana.",
  );
  ...
  return (
    <>
      ...
      >
        <p className="text-meta text-muted-foreground">Selecciona las monedas y métodos de pago que acepta tu negocio.</p>
        <PaymentChips />
      </FormSection>
      ...
      >
        <p className="text-meta text-muted-foreground">Añade tus platos o servicios más populares. Aparecen en la ficha del lugar.</p>
        <MenuItemEditor />
      </FormSection>
