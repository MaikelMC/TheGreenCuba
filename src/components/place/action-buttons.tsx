  ...
  return (
    <div className={cn("grid grid-cols-4 gap-gap-xs p-gap-md bg-surface lg:rounded-lv-lg lg:border lg:border-border lg:p-gap-lg", className)}>
      ...
      <button
        type="button"
        onClick={onNavigate}
        className="flex flex-col items-center justify-center gap-[6px] py-gap-sm px-gap-xs rounded-lv-lg border border-accent bg-accent text-white hover:bg-accent-hover hover:border-accent-hover active:scale-[0.97] transition-all duration-fast min-h-[72px]"
      >
      ...
      <button
        ...
        onClick={handleSave}
        className={cn(
          "flex flex-col items-center justify-center gap-[6px] py-gap-sm px-gap-xs rounded-lv-lg border active:scale-[0.97] transition-all duration-fast min-h-[72px]",
          saved
      ...
      >
        <Heart
          size={24}
          strokeWidth={2}
          className={saved ? "text-accent" : "text-accent"}
      ...
      <button
        type="button"
        onClick={onShare}
        className="flex flex-col items-center justify-center gap-[6px] py-gap-sm px-gap-xs rounded-lv-lg border border-border bg-surface hover:border-accent hover:bg-accent/10 active:scale-[0.97] transition-all duration-fast min-h-[72px]"
      >
